...
(function($) {
	// $('.number-counter').countTo();
			...
			if ($('.counter-parent').length > 0) {
				$('.counter-parent').appear(function() {
					$('.number-counter').countTo();
				});
			}
})(jQuery); 
...
function closePreloader(){
	...
	document.getElementsByClassName("preloaderCloseBtn")[0].style.display = "none"
}
...
// jQuery('#statistics-counter').on('load', function() {
